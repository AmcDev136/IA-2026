...
class Juego:
    def __init__(self) -> None:
        ...
        pygame.display.set_caption("Juego: Bala + salto + Árbol (solo memoria)")
        ...
        self.modelo: Optional[DecisionTreeClassifier] = None
    ...
    def exportar_datos_csv(self) -> str:
        ...
        base = os.path.dirname(__file__)
        ruta = os.path.join(base, "datos_arbol.csv")
    ...
    def graficar_datos_2d(self) -> str:
        ...
        fig_num = plt.figure("Datos Árbol - 2D", figsize=(8, 6)).number
        plt.figure(fig_num)
        plt.clf()
        ...
        ax.set_title("Datos entrenamiento Árbol de decisión (rojo=salto, azul=no salto)")
    ...
    def graficar_datos_3d(self) -> str:
        ...
        # Cerrar figura anterior si existe para evitar acumulación
        fig = plt.figure("Datos Árbol - 3D", figsize=(8, 6))
        plt.clf()
    ...
    def entrenar_modelo(self) -> Tuple[bool, str]:
        ...
        self.modelo = clf
        self.modelo_entrenado = True
        return True, f"Árbol entrenado. Accuracy test ≈ {acc:.3f}"
    ...
    def decision_auto_saltar(self) -> bool:
        ...
        if hasattr(self.modelo, "predict_proba"):
            proba_salto = float(self.modelo.predict_proba(X)[0][1])
    ...
    def _dibujar_menu(self, msg: str = "") -> None:
        ...
        opciones = [
            ...
            "G - Graficar datos en 2D",
            "H - Graficar datos en 3D",
            "F - Fullscreen (toggle)",
            "Q - Salir",
        ]
